...
Bionic.MainGame.prototype = {
    create: function() {
        ...
        this.player.bullets.physicsBodyType = this.Phaser.Physics.ARCADE;
        ...
        this.game.physics.enable(this.player, this.Phaser.ARCADE);
        ...
        */
        ...
        this.shoot = this.input.keyboard.addKey(this.Phaser.Keyboard.x);
        this.c_shoot = this.input.keyboard.addKey(this.Phaser.Keyboard.z);
    },
    update: function() {
        this.checkControls();
